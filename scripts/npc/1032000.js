// Regular Cab (Ellinia)
var maps = [104000000, 102000000, 103000000, 100000000];
var prices = [1200, 1000, 1200, 1000];

npc.sendBackNext("Hi! I drive the Regular Cab. If you want to go from town to town safely and fast, then ride our cab. We'll gladly take you to your destination with an affordable price.", false, true);
...
if (npc.sendYesNo("You don't have anything else to do here, huh? Do you really want to go to #b#m" + map + "##k? It'll cost you #b" + price + " mesos#k.")) {
    if (plr.mesos() >= price) {
        ...
        npc.sendBackNext("You don't have enough mesos. Sorry to say this, but without them, you won't be able to ride the cab.", true, true);
    }
} else {
