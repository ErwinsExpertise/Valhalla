...
const (
	...
	// DamageVarianceTolerance is the % tolerance for client damage validation
	// Allows for minor calculation differences between client and server
...
// WeaponType represents weapon types for damage calculations
// Uses the same values as itemID / 10000 % 100
type WeaponType int
...
const (
	...
	WeaponTypeDagger2  WeaponType = 33  // _2 suffix to avoid conflict with constants.go
	WeaponTypeWand2    WeaponType = 37  // _2 suffix to avoid conflict with constants.go
	WeaponTypeStaff2   WeaponType = 38  // _2 suffix to avoid conflict with constants.go
	WeaponTypeSword2H  WeaponType = 40
	WeaponTypeAxe2H    WeaponType = 41
	WeaponTypeBW2H     WeaponType = 42
	WeaponTypeSpear2   WeaponType = 43  // _2 suffix to avoid conflict with constants.go
	WeaponTypePolearm2 WeaponType = 44  // _2 suffix to avoid conflict with constants.go
	WeaponTypeBow2     WeaponType = 45  // _2 suffix to avoid conflict with constants.go
	WeaponTypeCrossbow2 WeaponType = 46  // _2 suffix to avoid conflict with constants.go
	WeaponTypeClaw2    WeaponType = 47  // _2 suffix to avoid conflict with constants.go
)
